  ...
  const quests = [
    {
      ...
      title: 'Discover, Digest, Delight with Gravitate AI!',
      description: 'We’ve developed a customizable personalized feed with AI recommendation for news/socials/blogs/video.',
    ...
    <div className="user-journey-container">
      <div className='user-journey-main'>
        <div className='user-journey-left-content'>
          ...
          <p className='content'>Yuliverse is a seek to earn gamefi + socialfi inspired by Pokemon Go and Tinder, targets p2e players and Pokemon Go players which is looking for a richer gaming experiences.</p>
          <p className='content'>By offering innovative offline urban treasure hunt and social experience in Web3 application, we attract players with revenue, retain players with social play, and finally drive players to real-world merchants or other valuable business activities... </p>
