                ...
                <div className="user-workspace-left-content">
                    ...
                    <div className='community-container'>
                        ...
                        <div className='community-content'>
                            <Accordion activeIndex={0} expandIcon="pi pi-chevron-circle-down" collapseIcon="pi pi-chevron-circle-up">
                                <AccordionTab headerTemplate={metamaskHeaderTemplate}>
                                    ...
                                    <div className='nft-group'>
                                        ...
                                        <AvatarGroup>
                                            ...
                                            <Avatar label="+5" shape="circle" size="large" style={{ backgroundColor: 'white', color: '#141414B2' }} />
                                        </AvatarGroup>
                                    </div>
                                </AccordionTab>
