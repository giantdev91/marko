        ...
        <div>
            ...
            <div className='doughnut'>
                ...
                <div className='flex flex-wrap flex-row align-items-center justify-content-between gap-4'>
                    <div className='flex-grow-1'><Doughnut title='Twitter' percentage={75} left_num={'400k'}
                                                           right_num={'1,5m'} />
                    </div>
                    <div className='flex-grow-1'><Doughnut title='Discord' percentage={60} left_num={'400k'}
                                                           right_num={'1m'} />
                    </div>
                    <div className='flex-grow-1'><Doughnut title='Telegram' percentage={75} left_num={'400k'}
                                                           right_num={'1m'} />
                    </div>
                </div>
            </div>
