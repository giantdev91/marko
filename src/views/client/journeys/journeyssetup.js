...
const JourneysSetup = ({ setTab }) => {
    ...
    const nextTab = () => {
        ...
        if (startDate == "") { setDateEmpty(true); } else { setDateEmpty(false) }
                        ...
                        <div className="admin-setup-component-container">
                            ...
                            <div className="ipt-text-div">
                                <div className='mb-3'>
                                    ...
                                    <input type="text" placeholder="Journey title" value={title} onChange={(e) => setTitle(e.target.value)}
