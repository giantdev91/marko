		...
		<>
			...
			<div className='admin-setting-content'>
				<div className='admin-setting-content-left'>
					<div className='admin-setting-block'>
						...
						<div className='block-input'>
							...
							<input value={projectName} placeholder="Marko" onChange={(e) => setProjectName(e.target.value)} />
						</div>
						<div className='block-input'>
							<label>Subdomain</label>
							<input value={subdomain} placeholder="marko.com/vitalik" onChange={(e) => setSubdomain(e.target.value)} />
						</div>
						<div className='block-input'>
							<label>Website link</label>
							<input value={website} placeholder="URL" onChange={(e) => setWebsite(e.target.value)} />
						</div>
						<div className='block-input'>
							<label>Community description</label>
							<input value={description} placeholder="URL" onChange={(e) => setDescription(e.target.value)} />
						</div>
					</div>
					<div className='admin-setting-block'>
						<div className='admin-setting-block-title'>
						...
						<div className='block-input'>
							...
							<input value={twitter} placeholder="URL" onChange={(e) => setTwitter(e.target.value)} />
						</div>
						<div className='block-input'>
							<label>
								<img src={DiscordIcon} />
							...
							<input value={discord} placeholder="URL" onChange={(e) => setDiscord(e.target.value)} />
						</div>
						<div className='block-input'>
							<label>
							...
							<input value={telegram} placeholder="URL" onChange={(e) => setTelegram(e.target.value)} />
						</div>
						<div className='block-input'>
							<a>Add more</a>
						</div>
				...
				<div className='admin-setting-content-right'>
					<div className='admin-setting-content-upload'>
						...
						{images.length > 0 ?
							<Dropzone2 onDrop={onDrop} accept={"image/*"} isEmpty={false} img={images[0]} deleteImg={deleteImg} />
							:
							<Dropzone2 onDrop={onDrop} accept={"image/*"} isEmpty={true} img={null} deleteImg={deleteImg} />
						}
					</div>
				</div>
			</div>
			<div className='admin-setting-member-table'>
				...
				<div className='admin-setting-member-table-content'>
					<DataTable value={members} scrollable scrollHeight="400px" tableStyle={{ minWidth: '50rem' }}>
