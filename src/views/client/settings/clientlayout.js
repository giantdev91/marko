			  	   ...
			  	   <div className="content-page" id="content-page">
							...
							<div className="admin-quest-memus-preview">
								<div className="admin-quest-menus">
									<Link to="#" onClick={ handleShow1 } className="admin-quest-menuitem">1. Set up</Link>
									<Link to="#" onClick={ handleShow2 } className="admin-quest-menuitem">2. Entries</Link>
									<Link to="#" onClick={ handleShow3 } className="admin-quest-menuitem">3. Eligibility</Link>
									<Link to="#" onClick={ handleShow4 } className="admin-quest-menuitem">4. Reward</Link>
								</div>
