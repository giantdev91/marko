...
const quests = [
    {
        title: `Quest On Going `,
        status: QUEST_STATUS.ON_GOING,
    },
    {
        title: `Quest On Going `,
    ...
    {
        title: `Quest On DRAFTS`,
        status: QUEST_STATUS.DRAFTS,
    },
    {
        title: `Quest On SCHEDULED`,
        status: QUEST_STATUS.SCHEDULED,
    },
    {
        title: `Quest On Going `,
        status: QUEST_STATUS.ON_GOING,
...
const QuestItem = ({ title, index, status }) => {
    ...
    const styles = {
        ...
        [QUEST_STATUS.ON_GOING]: {
            borderColor: color,
            background: '#fff',
        },
        [QUEST_STATUS.SCHEDULED]: {
        ...
        <div className={'quest-container mx-2 mb-4 justify-content-between'} style={{ height }}>
            <div className={'flex flex-row justify-content-between px-3 py-3 align-items-center'}>
                <div className={'flex flex-row'}>
                    ...
                    <span
                        style={{ marginLeft: 8, fontSize: 16, color: 'rgba(20, 20, 20, 0.3)' }}> {quests.length} </span>
                </div>
                <div>
