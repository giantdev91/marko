      ...
      <div className='main-part' style={{ borderRadius: '8px' }}>
        ...
        <div className={`${showRequest ? 'comment-container-request' : 'comment-container'}`}>
          <div className='flex flex-row align-items-center justify-content-between month-comment'>
            <div className='flex align-items-center justify-content-center month-btn'><img
              src={Left_Icon} alt={'left-icon'} /></div>
            <div className='flex flex-wrap align-items-center justify-content-between' style={{ width: '80%' }}>
              <span>August</span>
              <span>September</span>
              <span>October</span>
            </div>
            <div className='flex align-items-center justify-content-center month-btn'><img src={Right_Icon}
                                                                                           alt={'right-icon'} /></div>
          </div>
          <div className='flex align-items-center justify-content-between'>
            <span className='date-comment'>1</span><span className='date-comment'>8</span>
            <span
              className='date-comment'>16</span><span className='date-comment'>24</span><span
            className='date-comment'>31</span>
            <span className='date-comment'>1</span><span className='date-comment'>7</span><span
            className='date-comment'>14</span><span className='date-comment'>24</span><span
            className='date-comment'>31</span>
            <span className='date-comment'>7</span><span className='date-comment'>14</span><span
            className='date-comment'>24</span><span className='date-comment'>31</span>
          </div>
              ...
              showRequest ? <div className='quest-diagram-container'>
                {
                  Diagrams.map((item, index) => (
                    <div key={index}
                         style={{ bottom: `${item.bottom}%`, left: `${item.start}%`, width: `${item.width}px` }}
          ...
          <div className='flex align-items-center justify-content-center'>
            <div className='flex flex-wrap align-items-center justify-content-between gap-3'>
              <div className='flex align-items-center justify-content-center chk-box-discord'>
                <Checkbox inputId='ingredient1' name='discord' value='Discord' onChange={showDiscord}
                          checked={discordShow}
              ...
              <div className='flex align-items-center justify-content-center chk-box-twitter'>
                <Checkbox inputId='ingredient2' name='twitter' value='Twitter' onChange={showTwitter}
                          checked={twitterShow}
                          className='chk-show-box' />
