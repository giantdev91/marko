...
const AnalyticsTable = () => {
    ...
    const representativeUser = (rowData) => {
        return (<>
            <div>
                <div className='flex align-items-center'><img alt={rowData.user.image} src={rowData.user.image} style={{
                    width: '30px',
                    height: '30px',
                    marginRight: '8px',
                }} />
                    <span className={{ textAlign: 'left' }}>{rowData.user.name}</span></div>
            </div>
        </>);
    };
            ...
            <div>
                {
                    rowData.nft.slice(0, 3).map((item, index) => (
                        <img key={index} alt='item' src={item}
    ...
    let headerGroup =
        <ColumnGroup>
            <Row>
                <Column header='Name' rowSpan={2} field='user.name'
    ...
    return (
        <div>
            ...
            <div className='card' style={{ borderRadius: '8px' }}>
                <DataTable value={products} headerColumnGroup={headerGroup} showGridlines responsiveLayout='scroll'
                           style={{ borderRadius: '8px' }}>
                    <Column header='Name' field='user.name' body={representativeUser}
                    ...
                    <Column field='nft' header='NFT' body={representativeNFT}
                            className='analytics-datatable-cell'></Column>
