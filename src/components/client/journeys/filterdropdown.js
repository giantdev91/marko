                    ...
                    <ul className="filter-dropdown-list">
                        {
                            filters.map((filter, index) =>
                                <li key={index} onClick={(e) => { e.preventDefault(); select(filter.value); }} className="list-item">
                                    <Checkbox inputId={filter.text} name="filter" value={filter.value} checked={filterValues.some((filterValue) => filterValue === filter.value)} />
