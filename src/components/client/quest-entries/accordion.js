...
const Accordion = ({
  hunting, addHunting, community, addCommunity,
  ...
  watchyoutube, addWatchYoutube, subyoutube, addSubYoutube, likeyoutube, addLikeYoutube, commentyoutube, addCommentYoutube,
    ...
    return (
        <>            
            <AccordionItemSocial  content={accordionData[0]} onToggle={ () => handleToggle(0) }
                active={ clicked === 0 } 
                ...
                />         
            <AccordionItemEducational  content={accordionData[1]} onToggle={ () => handleToggle(1) }
                active={ clicked === 1 } questionanswer={questionanswer} addQuestionAnswer={addQuestionAnswer} visitanswer={visitanswer} addVisitAnswer={addVisitAnswer} 
                articleanswer={articleanswer} addArticleAnswer={addArticleAnswer}/>         
            <AccordionItemGovernance  content={accordionData[2]}   onToggle={ () => handleToggle(2) }
                active={ clicked === 2 } hunting={hunting} addHunting={addHunting} community={community} addCommunity={addCommunity}/>         
            <AccordionItemTechnicial  content={accordionData[3]} onToggle={ () => handleToggle(3) }
                active={ clicked === 3 } proofsstaking={proofsstaking} addProofsStaking={addProofsStaking} proofsliquidity={proofsliquidity}
