...
const TechnicalProofsTrading = ({closeActivity}) => {
    ...
    return(
        ...
        <div className="activity-item">
            <div className='close-btn'>
                <img src={Close_Icon} className='close-btn' onClick={() => closeActivity('TechnicalProofsTrading')}/>
            </div>
            <div className={`flex flex-row align-items-center justify-content-between ${active ? 'mb-4' : ''}`} onClick={() => setActive(!active)}>
                <span>Proofs of trading volume</span>
