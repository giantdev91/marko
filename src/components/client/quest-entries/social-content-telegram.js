...
const SocialContentTelegram = ({jointelegram, addJoinTelegram, verifytelegram, addVerifyTelegram,
    checktelegram, addCheckTelegram}) => {
    ...
    return (
        <>  
            <div className={`accordion-content-item`}  onClick={addJoinTelegram}>
                {jointelegram !== "-1" ? <img src={Active_Icon}/> : <img src={Inactive_Icon}/>} <span className='title'> {titles[0]} </span> 
            </div>
            <div  className={`accordion-content-item`}  onClick={addVerifyTelegram}>
                {verifytelegram !== "-1" ? <img src={Active_Icon}/> : <img src={Inactive_Icon}/>} <span className='title'> {titles[1]} </span> 
            </div>
            <div  className={`accordion-content-item`}  onClick={addCheckTelegram}>
                {checktelegram !== "-1" ? <img src={Active_Icon}/> : <img src={Inactive_Icon}/>} <span className='title'> {titles[2]} </span> 
            </div>
