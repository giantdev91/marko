...
const SocialContentDiscord = ({joindiscord, addJoinDiscord, verifydiscord, addVerifyDiscord, checkdiscord, addCheckDiscord}) => {
    ...
    return (
        <>  
            <div className={`accordion-content-item`}  onClick={addJoinDiscord}>
                {joindiscord !== "-1" ? <img src={Active_Icon}/> : <img src={Inactive_Icon}/>} <span className='title'> {titles[0]} </span> 
            </div>
            <div  className={`accordion-content-item`}  onClick={addVerifyDiscord}>
                {verifydiscord !== "-1" ? <img src={Active_Icon}/> : <img src={Inactive_Icon}/>} <span className='title'> {titles[1]} </span> 
            </div>
            <div  className={`accordion-content-item`}  onClick={addCheckDiscord}>
                {checkdiscord !== "-1" ? <img src={Active_Icon}/> : <img src={Inactive_Icon}/>} <span className='title'> {titles[2]} </span> 
            </div>
