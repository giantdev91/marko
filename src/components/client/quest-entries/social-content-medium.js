...
const SocialContentMedium = ({ joinmedium, addJoinMedium, verifymedium, addVerifyMedium, checkmedium, addCheckMedium }) => {
    ...
    return (
        <>  
            <div className={`accordion-content-item`}  onClick={addJoinMedium}>
                {joinmedium !== "-1" ? <img src={Active_Icon}/> : <img src={Inactive_Icon}/>} <span className='title'> {titles[0]} </span> 
            </div>
            <div  className={`accordion-content-item`}  onClick={addVerifyMedium}>
                {verifymedium !== "-1" ? <img src={Active_Icon}/> : <img src={Inactive_Icon}/>} <span className='title'> {titles[1]} </span> 
            </div>
            <div  className={`accordion-content-item`}  onClick={addCheckMedium}>
                {checkmedium !== "-1" ? <img src={Active_Icon}/> : <img src={Inactive_Icon}/>} <span className='title'> {titles[2]} </span> 
            </div>
