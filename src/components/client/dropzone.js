          ...
          !isEmpty ?
                    <>
                        ...
                        <div className="flex align-items-center gap-3">
                          <Button label="Delete" severity="secondary" className='flex-grow-1 quest-setup-del-btn' onClick={deleteImg} outlined />
                          <Button label="Update" severity="secondary" className='flex-grow-1 quest-setup-del-btn' onClick={open} outlined />
                  ...
                  <div className={`${photoEmpty ? 'dropzone-div-emtpy': 'dropzone-div'}`} {...getRootProps()}>
                    ...
                    <div className="text-center">
                      {isDragActive ? (
                        ...
                        <>
                          <img src={ !photoEmpty ? DragDropImg : DragDropImgEmpty } className="drag-drop-element"/>
                          <p>
